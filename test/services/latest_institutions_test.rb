...
describe "retrieve latest institutions" do
  it "get the expected institution list" do
    ...
    create(:institution, date: '2021-08-02', created_at: '2021-08-04', name: 1, firm: firm1)
    create(:institution, date: '2021-08-03', created_at: '2021-08-04', name: 2, firm: firm2)
    create(:institution, date: '2021-08-04', created_at: '2021-08-04', name: 3, firm: firm3)
    create(:institution, date: '2021-08-05', created_at: '2021-08-04', name: 4, firm: firm4)
    create(:institution, date: '2021-08-02', name: 5, firm: firm5)
